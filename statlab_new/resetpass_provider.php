...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<br><br><br><br><br><br>
			<form name="frmChange" id="frmChange" method="post" action="resetpasscheck_provider.php">
				...
				<table style="margin: 1% 0% 1% 0%" text-align="center" class="table">
					<!-- <tr class="tableheader">						
						...
						<div class="form-group">		
							<div class="alert alert-success" id="successform" style="display: none; font-size:32px; text-align:center;">
...
<script type="text/javascript">
	function cancelpass(){
		location.href = "menu_provider.php";
	}
</script>
<script type="text/javascript">
