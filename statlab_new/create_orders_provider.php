					...
					<form>
						...
						<div class="row">
							...
							<div class="col-md-10">
								...
								<div class="form-group row">
									<div class="col-md-12">
										<button type="button" class="btn btn-primary" style="width:100%;" id="printRF" onclick="printDiv('printableArea')" disabled="disibled"><i class="fa fa-print"></i>   PRINT Requisiton Form</button>
									</div>							 
								</div>			
								<div class="form-group row">
									<div class="col-md-12">
...
$('#returnmenu').click(function(){
	if (document.getElementById("printRF").disabled == false || document.getElementById("send").disabled == false)
	{
...
function saveinfo(){
	...
	t_test1:t_test1,t_test2:t_test2,t_test3:t_test3,t_test4:t_test4,t_test5:t_test5,t_test6:t_test6,t_test7:t_test7,type:1}, function(data, status){
		console.log(data);
		// alert(data);
		if(status == "success"){
			$("#alertform1").show();
...
function deleteinfo(){
	$.post("deleteorder.php",{type:1}, function(data, status){
		console.log(data);
		// alert(data);
		if(status == "success"){
			$("#alertform2").show();
...
function printDiv(divName) {
	// window.location.href = "print_orders.php?orderid="+"<?php echo $flag ?>";
	window.open(
		"print_orders.php?orderid="+"<?php echo $flag ?>",
  		'_blank' 
);
}
function printSL(){
...
function sendlab(){
	$.post("sendorder.php",{type:1}, function(data, status){
		console.log(data);
		// alert(data);
		if(status == "success"){
			$("#alertform3").show();
