<?php
	...
	Patients pa ON ord.PatientID = pa.PatientID AND ord.clientID = pa.clientID Left JOIN SpecimenType sp ON sp.SpecimenType = ord.SpecimenType Left JOIN OrderTests ot ON ord.OrderID = ot.OrderID Left JOIN Tests t ON t.TestID = ot.TestID 
	Left JOIN Providers pr ON ord.ProviderID = pr.ProviderID Left JOIN Race ra on ra.RaceID = pa.RaceID Left JOIN Ethnicity et on et.EthnicityID = pa.EthnicityID WHERE ord.OrderID = '$flag'" ) or die("database error:". sqlsrv_error($conn));
	$result = array();
...
function saveinfo(){
	...
	t_test1:t_test1,t_test2:t_test2,t_test3:t_test3,t_test4:t_test4,t_test5:t_test5,t_test6:t_test6,t_test7:t_test7,id:flag,type:0}, function(data, status){
		console.log(data);
		// alert(data);
		if(status == "success"){
			$("#alertform1").show();
...
function deleteinfo(){
	$.post("deleteresult.php",{id:"<?php echo $flag?>",type:0}, function(data, status){
		console.log(data);
		// alert(data);
		if(status == "success"){
			$("#alertform2").show();
...
function sendlab(){
	$.post("sendresult.php",{id:"<?php echo $flag?>", type:0}, function(data, status){
		console.log(data);
		// alert(data);
		if(status == "success"){
			$("#alertform3").show();
