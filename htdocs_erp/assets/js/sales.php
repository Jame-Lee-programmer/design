...
<script type="text/javascript">
    ...
    function save_ei_items_order() {
        var rows = $('.table.invoice-items-preview.items tbody tr,.table.estimate-items-preview.items tbody tr,.table.proposal-items-preview.items tbody tr,.table.todo-preview.items tbody tr,.table.purchase-items-preview.items tbody tr');
        var i = 1;
        var order = [];
        var _order_id, type;
        var item_id;
