...
class Gst
{
    ...
    function genHTML($tax_summary = [])
    {
        ...
        if (!empty($tax_summary)) {
            ...
            $html .= '</tbody></tfoot>';
            $html .= '<tr class=""><th colspan="' . $cols . '" class="text-right">' . lang('total') . '</th><th class="text-right">' . display_money($total_tax) . '</th><th class="text-right">' . display_money($total_cost) . '</th></tr>';
