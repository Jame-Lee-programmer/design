...
class Attendance extends Admin_Controller
{
    ...
    public function saved_manual_time()
    {
        ...
        $clockin_time = date('H:i:s', strtotime($adata['date_in']));
        $clockout_time = date('H:i:s', strtotime($adata['date_out']));
...
// Update into tbl_project
    ...
    public function attendance_report()
    {
        ...
        $data['all_department'] = by_company('tbl_departments', 'departments_id');
    ...
    public function get_report()
    {
        ...
        $data['companies_id'] = $this->input->post('companies_id', TRUE);
        ...
        $data['all_department'] = by_company('tbl_departments', 'departments_id', null, $data['companies_id']);
