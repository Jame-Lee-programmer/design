...
class Job_Circular extends Admin_Controller
{
        ...
        if (!empty($id)) {
            ...
            if (!empty($can_edit)) {
                ...
                if (empty($data['job_posted'])) {
                    ...
                    $companies_id = $data['job_posted']->companies_id;
                }
            }
        }
    ...
    function view_circular_details($id)
    {
        ...
        $data['job_posted'] = get_row('tbl_job_circular', array('job_circular_id' => $id));
        if (empty($data['job_posted'])) {
    ...
    function call_for_interview($id, $interview_date)
    {
        ...
        if (!empty($job_application_info)) {
            ...
            $date = str_replace("{DATE}", display_datetime($interview_date), $designation);
