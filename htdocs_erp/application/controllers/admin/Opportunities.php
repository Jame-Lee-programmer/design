...
class Opportunities extends Admin_Controller
{
    ...
    public function index($id = NULL)
    {
        ...
        $opportunities_state_reason = get_result('tbl_opportunities_state_reason');
...
// Update into tbl_project
    ...
    public function saved_metting($opportunities_id, $id = NULL)
    {
        ...
        $data = $this->items_model->array_from_post(array('meeting_subject', 'start_date', 'end_date', 'user_id', 'location', 'description'));
        $data['opportunities_id'] = $opportunities_id;
