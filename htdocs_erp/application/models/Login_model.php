...
class Login_Model extends MY_Model
{
    ...
    public function login()
    {
        ...
        if (!empty($admin)) {
            if (!empty($admin->companies_id)) {
                $company_info = $this->check_by(array('status' => 1, 'companies_id' => $admin->companies_id), 'tbl_companies');
            ...
            if ($admin->role_id != '2') {
                ...
                if ($user_info->company != '-') {
                    ...
                    $client_info = get_row('tbl_client', array('client_id' => $user_info->company));
