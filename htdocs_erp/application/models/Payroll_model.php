...
class Payroll_Model extends MY_Model
{
    ...
    public function get_emp_salary_list($id = NULL, $designation_id = NULL)
    {
        ...
        if (!empty($companies_id)) {
            if ($this->db->field_exists('companies_id', 'tbl_departments')) {
                $this->db->where('tbl_departments.companies_id', $companies_id);
            }
        }
    ...
    public function get_attendance_info_by_date($start_date, $end_date, $user_id)
    {
        ...
        $companies_id = $this->session->userdata('companies_id');
        if (!empty($companies_id)) {
            if ($this->db->field_exists('companies_id', 'tbl_attendance')) {
    ...
    public function get_provident_fund_info_by_date($start_date, $end_date, $user_id = null)
    {
        ...
        $companies_id = $this->session->userdata('companies_id');
        if (!empty($companies_id)) {
            if ($this->db->field_exists('companies_id', 'tbl_salary_payment')) {
                $this->db->where('tbl_salary_payment.companies_id', $companies_id);
            }
        }
        if (!empty($user_id)) {
