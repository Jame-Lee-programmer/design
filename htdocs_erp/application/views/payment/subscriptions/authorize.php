...
<div class="panel panel-custom">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2">
                <input type="text" id="cvv" size="4"  name="cvv" class="form-control card-cvc input-mini" autocomplete="off"
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2">
                <input type="text" maxlength="2" id="expMonth" name="expMonth" class="form-control input-mini" autocomplete="off"
                       placeholder="MM" required>

            </div>
            <div class="col-lg-2">
                <input type="text" maxlength="4" id="expYear"  name="expYear" autocomplete="off" class="form-control input-mini"
                       placeholder="YYYY"
                       required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <input type="email" name="email" class="form-control" required
                       value="<?php echo $subs_info->email; ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg-4 control-label">
