...
<div class="auto-container">
    ...
    <span
            class="set_price btn btn-xs <?= (!empty($interval_type) && $interval_type == 'monthly' || empty($interval_type) ? 'custom-bg active' : 'btn-primary') ?> by_type"
            result="by_type"
            type="monthly"><?= lang('monthly') ?></span>
            <span
                    class="set_price btn btn-xs <?= (!empty($interval_type) && $interval_type == 'annually' ? 'custom-bg active' : 'btn-primary') ?> by_type"
                    type="annually"
            ...
            if (!empty($all_currency)) {
                foreach ($all_currency as $v_currency) {
                    ...
                    <span currency="<?= $v_currency->currency ?>" result="by_currency"
                          class="set_price btn btn-xs currencywise_price <?= (!empty($currency_type) && $currency_type == $v_currency->currency || (empty($currency_type) && $v_currency->currency == config_item('default_currency')) ? 'custom-bg active' : 'btn-primary') ?>"><?= $c_name->name . '(' . $c_name->symbol . ')' ?></span>
                <?php }
            }
            ?>
        </div>
                        ...
                        <div class="">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input name="domain" required class="main_domain" min="3" id="domain" value=""
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input name="name" required value="" placeholder="<?= lang('name') ?> *"
                                           type="text">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input name="mobile" value="" required placeholder="<?= lang('mobile') ?> *"
                                           type="text">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
