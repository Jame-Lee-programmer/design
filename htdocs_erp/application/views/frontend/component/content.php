...
<div class="cps-main-wrap">
                    ...
                    <div class="cps-counter-items">
                        <div class="col-sm-3 col-xs-6">
                            <div class="cps-counter-item">
                                ...
                                <h3 class="cps-fact-number"><span class="cps-count" data-form="0"
                                                                  data-to="<?= config_item('happy_clients') ?>"></span>
                                </h3>
                        ...
                        <div class="col-sm-3 col-xs-6">
                            <div class="cps-counter-item">
                                ...
                                <h3 class="cps-fact-number"><span class="cps-count" data-form="0"
                                                                  data-to="<?= config_item('awards_win') ?>"></span>
                                </h3>
                        ...
                        <div class="col-sm-3 col-xs-6">
                            <div class="cps-counter-item">
                                ...
                                <h3 class="cps-fact-number"><span class="cps-count" data-form="0"
                                                                  data-to=" <?= config_item('finished_work') ?>"></span>
                                </h3>
                        ...
                        <div class="col-sm-3 col-xs-6">
                            <div class="cps-counter-item">
                                ...
                                <h3 class="cps-fact-number"><span class="cps-count" data-form="0"
                                                                  data-to="<?= config_item('team_members') ?>"></span>
                                </h3>
            ...
            <div class="container">
                ...
                <div class="cps-testimonials-wrap">
                    <div class="owl-carousel testimonial-carousel" id="testimonial-carousel-2">
                        ...
                        foreach ($qry_testi->result() as $qry_testi_res) {
                            ?>
    ...
    <!-- Contact -->
    <div class="cps-section cps-section-padding-50 contact_us parallax" id="contact_us"
