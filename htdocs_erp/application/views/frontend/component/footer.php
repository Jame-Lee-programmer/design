                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="cps-widget about-widget">
                            <a class="cps-footer-logo" href="#">
                                <img src="<?= base_url(config_item('company_logo')) ?>"
                                     alt="<?= $title ?> Logo">
                            </a>
                            <p><?= config_item('company_description') ?></p>
                            <div class="cps-socials">
                                <a href="https://www.facebook.com/<?= config_item('office_facebook') ?>"><i
                                            class="fa fa-facebook"></i></a>
                                <a href="https://twitter.com/<?= config_item('office_twitter') ?>"><i
                                            class="fa fa-twitter"></i></a>
                                <a href="https://plus.google.com/+<?= config_item('office_google_plus') ?>"><i
                                            class="fa fa-google-plus"></i></a>
                                <a href="https://www.linkedin.com/in/<?= config_item('office_linkedin') ?>"><i
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-xs-12 xs-text-center">
                    <p class="copyright">Copyright 2018, <a href="#">CodexCube</a>. All Rights Reserved</p>
                </div>
