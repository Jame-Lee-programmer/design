            ...
            <div class="tab-pane <?= $active == 1 ? 'active' : ''; ?>" id="manage">
                ...
                <?php if (!empty($created) || !empty($edited)){
                    ...
                    <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="new">
                        ...
                        <div class="form-group" id="super_admin" <?php
                        if (!empty($login_info) && $login_info->super_admin == 'Yes') {
                            echo 'style="display:block"';
                        }
                        ?>>
                            <label
                                    class="col-sm-3 control-label"><strong><?= lang('super_admin') ?> </strong></label>
                            <div class="col-sm-5">
                                <div class="checkbox-inline c-checkbox">
                                    <label class="needsclick">
                                        ...
                                        ?> value="Yes" type="checkbox" style="margin-right: 8px;"
                                               class="super_admin">
                        ...
                        <div class="form-group" id="owner" <?php
                        if (!empty($login_info) && $login_info->super_admin == 'owner') {
                            echo 'style="display:block"';
                        }
                        ?>>
                            <label
                                    class="col-sm-3 control-label"><strong><?= lang('owner') ?> </strong></label>
                            <div class="col-sm-5">
                                <div class="checkbox-inline c-checkbox">
                                    <label class="needsclick">
                                        <input name="super_admin" <?php
                                        ...
                                        ?> value="owner" type="checkbox" style="margin-right: 8px;"
                                               class="owner">
                                        <span class="fa fa-check"></span>
                                    </label>
                                </div>
                            ...
                            <div class="col-sm-6 row">
                                <div id="client_permission" class="panel panel-custom ">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <label
                                                    class="col-sm-3 control-label"><strong><?= lang('select_client') ?> </strong></label>
                                            <div class="col-sm-6">
