            ...
            <div class="col-sm-8">
                ...
                <div class="panel_controls">
                    <?php if ($this->session->userdata('user_type') == 1) { ?>
                        <?php
                        $companies_id = null;
                        super_admin_form($companies_id, 3, 8) ?>
                        <div class="form-group">
                            <label for="field-1"
                                   class="col-sm-3 control-label"><?= lang('select') . ' ' . lang('employee') ?>
                                <span
                            ...
                            <div class="col-sm-8">
                                <select name="user_id" style="width: 100%" onchange="get_leave_details(this.value)"
                                    ...
                                    <option
                                        value=""><?= lang('select') . ' ' . lang('employee') ?></option>
                                    <?php
                                        ...
                                        <?php foreach ($all_employee as $dept_name => $v_all_employee) : ?>
                                            <optgroup label="<?php echo $dept_name; ?>">
                                                <?php if (!empty($v_all_employee)):foreach ($v_all_employee as $v_employee) : ?>
                                                    <option
                                                        value="<?php echo $v_employee->user_id; ?>" <?= ($v_employee->user_id == $this->session->userdata('user_id')) ? 'selected' : '' ?>
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text" name="single_day_start_date" id="single_day_start_date"
                                       ...
                                       class="form-control only_datepicker" value=""
