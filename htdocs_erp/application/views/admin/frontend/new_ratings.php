...
<div class="panel panel-custom">
    ...
    <div class="modal-body wrap-modal wrap">
        ...
        <div class="form-group">
            <label for="field-1" class="col-sm-3 control-label"><?= lang('ratings') ?>
                <span class="required">*</span></label>

            <div class="col-sm-7">
                <input required type="text" name="ratings" data-parsley-type="number"
                       placeholder="<?= lang('enter') . ' ' . lang('ratings') ?>"
                       class="form-control" value="<?php
                if (!empty($ratings_info->ratings)) {
                    echo $ratings_info->ratings;
                }
                ?>"/>
            </div>
        </div>
