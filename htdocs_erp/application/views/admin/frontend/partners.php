<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs">
        <li class="<?= $active == 1 ? 'active' : ''; ?>"><a href="#manage"
                                                            data-toggle="tab"><?= lang('all') . ' ' . lang('partners') ?></a>
        </li>
        <li class="<?= $active == 2 ? 'active' : ''; ?>"><a href="#create"
                                                            data-toggle="tab"><?= lang('new') . ' ' . lang('partners') ?></a>
        </li>
    </ul>
    <div class="tab-content bg-white">
                            ...
                            <tr class="partners" data-id="<?= $partners->id ?>"
                                ...
                                <td>
                                    <div class="checkbox ajax_change_status">
                                        <input data-id="<?= $partners->id ?>" data-toggle="toggle"
                                               name="status"
                                ...
                                <td>
                                    ...
                                    <?php echo ajax_anchor(base_url("admin/frontend/delete/tbl_partners/$partners->id"), "<i class='btn btn-xs btn-danger fa fa-trash-o'></i>", array("class" => "", "title" => lang('delete'), "data-fade-out-on-success" => "#table_partners_" . $partners->id)); ?>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } ?>
        ...
        <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
            ...
            <div class="form-group">
                <label
                    class="col-lg-3 control-label"><?= lang('dribbble_profile_link') ?></label>
                <div class="col-lg-5">
                    <input type="text" class="form-control" value="<?php
