...
if (!empty($expense_info)) {
    $projects_id = $expense_info->project_id;
...
?>
<?php echo form_open(base_url('admin/projects/save_invoice/' . $projects_id), array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '', 'role' => 'form')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                ...
                                if (!empty($invoice_info) && $invoice_info->recurring == 'Yes') {
                                    $recur_start_date = display_datetime($invoice_info->recur_start_date);
                                    $recur_end_date = display_datetime($invoice_info->recur_end_date);
                                } else {
                ...
                <tr class="hidden-print">
                    ...
                    <td>
                        <select name="item_tax_rate[]" class="form-control  ">
                            ...
                            <?php
                            $tax_rates = get_result('tbl_tax_rates');
                            if (!empty($tax_rates)) {
