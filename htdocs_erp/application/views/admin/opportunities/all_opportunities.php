                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <?php
                            if (!empty($opportunity_info)) {
                                $close_date = date('Y-m-d H:i', strtotime($opportunity_info->close_date));
                                $next_action_date = date('Y-m-d H:i', strtotime($opportunity_info->next_action_date));
                            } else {
                                $close_date = date('Y-m-d H:i');
                                $next_action_date = date('Y-m-d H:i');
                            }
                            ?>
                            <div class="col-lg-4">
