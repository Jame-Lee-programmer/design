<div class="row">
    <div class="col-sm-12" data-spy="scroll" data-offset="0">
        <div class="panel panel-custom"><!-- *********     Employee Search Panel ***************** -->
            ...
            <?php echo form_open(base_url('admin/payroll/payroll_summary'), array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '', 'role' => 'form')); ?>
            ...
            if (!empty($employee_payroll)) {
                foreach ($employee_payroll as $index => $v_payroll) {
                    ...
                    <tr>
                        ...
                        <td><?php echo display_datetime($v_payroll->paid_date); ?></td>
    ...
    <div class="col-sm-12" data-spy="scroll" data-offset="0">
        <div class="panel panel-custom">
            ...
            <table class="table table-striped" id="Transation_DataTables">
                ...
                <tbody>
                <?php
                $activities_info = get_result('tbl_activities', array('module' => 'payroll'));
