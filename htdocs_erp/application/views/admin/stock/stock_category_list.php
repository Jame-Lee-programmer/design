                                    ...
                                    <?php if (!empty($v_stock_category_info)):
                                        ...
                                        <div class="box-heading">
                                            <div class="box-title">
                                                <h4><?php echo $category ?>
                                                    ...
                                                    <span
                                                            class="text-sm"><?php super_admin_invoice($stock_category_info[$akey]->companies_id); ?></span>
                                                </h4>
                                            </div>
                                        </div>
                                        ...
                                        if (!empty($v_stock_category->stock_sub_category)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-toggle="modal" data-target="#myModal"  href="<?= base_url('admin/stock/items_details_stock_category/' . $v_stock_category->stock_sub_category_id) ?>"> <?php echo $v_stock_category->stock_sub_category ?></a>
                                                </td>
                                                <?php if (!empty($edited) && !empty($deleted)) { ?>
                                                    <td>
                                                        <?php if (!empty($edited)) { ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label
                                            class="col-lg-4 control-label"><?= lang('select') . ' ' . lang('categories') ?>
                                        <span
