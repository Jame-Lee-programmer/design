...
if ($leads_details->converted_client_id == 0) {
    ...
    <?php }
                    ...
                    <div class="panel-body row form-horizontal task_details">
                        <?php super_admin_details_p($leads_details->companies_id, 5) ?>
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group">
                                            ...
                                            if (!empty($mettings_info->start_date)) {
                                                echo date('Y-m-d H:i', strftime($mettings_info->start_date));
                                            } else {
                                                echo date('Y-m-d H:i');
                                            }
                                            ?>"
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group">
                                            ...
                                            if (!empty($mettings_info->end_date)) {
                                                echo date('Y-m-d H:i', strftime($mettings_info->end_date));
                                            } else {
                                                echo date('Y-m-d H:i');
                                            }
                                            ?>"
                                    ...
                                    <div class="col-lg-5">
                                        <div class="input-group">
                                            <input type="text" name="date"
                                                   ...
                                                   ?>"
                                                   data-date-min-date="<?= date('Y-m-d H:i'); ?>">
                                            <div class="input-group-addon">
                                                <a href="#"><i class="fa fa-calendar"></i></a>
                                            </div>
                                        </div>
