                    ...
                    <?php if (!empty($deleted) || !empty($edited)) { ?>
                        ...
                        <a href="<?= base_url() ?>admin/award/give_award/<?= $v_award_info->employee_award_id ?>"
                           ...
                           data-placement="top" data-target="#myModal">
                            ...
                            <?php }
                            if (!empty($deleted)) { ?>
                                <?php echo ajax_anchor(base_url("admin/award/delete_employee_award/$v_award_info->employee_award_id"), "<i class='btn btn-xs btn-danger fa fa-trash-o'></i>", array("class" => "", "title" => lang('delete'), "data-fade-out-on-success" => "#table_" . $v_award_info->employee_award_id)); ?>
                            <?php } ?>
                        </td>
                    <?php } ?>
                </tr>
