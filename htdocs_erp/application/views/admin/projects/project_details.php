                ...
                <div class="panel panel-custom">
                    ...
                    <div class="panel-body form-horizontal task_details">
                            ...
                            <div class="row">
                                <div class="col-md-3 br">
                                    ...
                                    <form class="form-horizontal p-20">
                                        ...
                                        <?php super_admin_details($project_details->companies_id) ?>
                        ...
                        <?php } else { ?>
                            <div class="form-group ">
                                <div class="col-sm-6">
                                    <label class="control-label col-sm-4"><strong><?= lang('project_name') ?> :</strong></label>
                    ...
                    <div class="tab-content bg-white">
                        ...
                        <div class="tab-pane <?= $time_active == 2 ? 'active' : ''; ?>" id="contact">
                            <form role="form" enctype="multipart/form-data" id="form"
                                ...
                                <?php
                                if (!empty($project_timer_info)) {
                                    $start_date = date('Y-m-d H:i', $project_timer_info->start_time);
                                    $end_date = date('Y-m-d H:i', $project_timer_info->end_time);
                                } else {
