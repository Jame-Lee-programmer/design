<div class="panel panel-custom">
    ...
    <div class="modal-body wrap-modal wrap">
        <?php echo form_open(base_url('admin/invoice/add_insert_items/' . $invoices_id), array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '', 'role' => 'form')); ?>
