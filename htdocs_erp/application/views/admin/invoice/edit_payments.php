    ...
    <div class="col-sm-5">
        <div class="panel panel-custom">
            ...
            <div class="panel-body">
                <?php echo form_open(base_url('admin/invoice/update_payemnt/' . $payments_id), array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '', 'role' => 'form')); ?>
