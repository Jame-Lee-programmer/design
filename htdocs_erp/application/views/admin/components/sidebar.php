                        ...
                        <li class="sub-menu ">
                            ...
                            <ul id="frontend" class="nav sidebar-subnav collapse" aria-expanded="false">
                                ...
                                <li class="<?= ($this->uri->segment(3) == 'home') ? 'active' : '' ?>">
                                    <a title="<?= lang('header') ?>"
                                       href="<?= base_url('admin/frontend/home') ?>">
                                        <em class="fa fa-circle-o"></em><span><?= lang('home') ?></span></a>
                                </li>
                                ...
                                <li class="<?= ($this->uri->segment(3) == 'features') ? 'active' : '' ?>">
                                    <a title="<?= lang('features') ?>"
                                       href="<?= base_url('admin/frontend/features') ?>">
                                        <em class="fa fa-circle-o"></em><span><?= lang('features') ?></span></a>
                                </li>
                                ...
                                <li class="<?= ($this->uri->segment(3) == 'partners') ? 'active' : '' ?>">
                                    <a title="<?= lang('partners') ?>"
                                       href="<?= base_url('admin/frontend/partners') ?>">
                                        <em class="fa fa-circle-o"></em><span><?= lang('partners') ?></span></a>
                                </li>
