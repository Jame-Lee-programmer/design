<div class="panel panel-custom">
    ...
    <div class="panel-heading">
        <div class="panel-title">
            <a class="pull-right" href="<?= base_url() ?>admin/utilities/overtime"> <span
    ...
    <div class="panel-body form-horizontal">
        <?php super_admin_details_p($overtime_info->companies_id) ?>
        <div class="">
        ...
        <div class="">
            ...
            <div class="col-sm-8">
                <p class="form-control-static"><?= display_date($overtime_info->overtime_date) ?></p>
            </div>
        </div>
        <div class="">
            <div class="col-sm-4 text-right">
        ...
        <div class="">
            ...
            <div class="col-sm-8">
                <blockquote
                        style="font-size: 12px; margin-top: 5px"><?= strip_tags($overtime_info->notes) ?></blockquote>
            </div>
        </div>
    </div>
</div>
