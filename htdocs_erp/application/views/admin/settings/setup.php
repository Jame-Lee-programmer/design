                        ...
                        if ($step == 1) { ?>
                            <div class="step-pane <?= $step1 ?>" id="step1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" required class="form-control" id="check_email"
...
//        alert('done');
                                        ...
                                        if (activation_token) {
                                            ...
                                            btn = 'next';
                                            url = 'check_existing_activation_token';
                        ...
                        <?php if ($step == 5) {
                            ...
                            <ul class="list-unstyled">
                                <li>Administrators needs to login at <a href="<?php echo $base_url; ?>login" target="_blank"><?php echo $base_url; ?>login</a></li>
                            </ul>
                            <hr/>
                        <?php } ?>
