...
<div class="col-sm-8 ">
    <div class="form-group">
        <label for="discount_type"
               class="control-label col-sm-3"><?= lang('billing_cycle') ?><span
        ...
        <div class="col-sm-5">
            ...
            echo form_dropdown('billing_cycle', $options, $interval_type, 'style="width:100%" id="billing_cycle"  class="form-control"'); ?>
            <small><?= lang('plan_renews') ?> <span
                    class="plan_renews"><?= date("Y-m-d", strtotime("+ " . $renew_date)); ?></span>
                @ <?= display_money($c_amount, $currency->symbol) ?>/<?= lang($interval_type) ?></small>
        </div>
        <input type="hidden" class="form-control" id="pricewise_currency" name="currency"
               value="<?= $currency_code ?>">
    ...
    <div class="form-group" id="coupon_code_area" style="display: none">
        <label for="discount_type"
               class="control-label col-sm-3"><?= lang('enter_coupon_code') ?><span
                class="required">*</span></label>
        <div class="col-sm-5">
    ...
    <table class="table text-right">
        ...
        <tr id="">
            ...
            <td><h4 class="m0"><?= lang('free') ?></h4></td>
        </tr>
        <tr id="">
        ...
        <tr id="">
            ...
            <td><h4 class="m0"><?= $package_info->trial_period + 1 . ' ' . lang('days') ?></h4></td>
        </tr>
        <tr>
            <td><span class="bold"><?= lang('sub_total') ?> :</span>
            </td>
            <td><strong
                    class="sub_total_text"><?= display_money($c_amount, $currency->symbol) ?></strong>
                <input type="hidden" class="sub_total_input" name="subtotal"
                       value="<?= $c_amount ?>">
            </td>
            <input type="hidden" name="renew_date" id="renew_date"
                   value="<?= date("Y-m-d", strtotime("+ " . $renew_date)); ?>"></td>
        </tr>
        <tr id="discount_area">
            <td>
            ...
            <td><strong class="discount_amount_text"></strong>
                <input type="hidden" name="discount_amount" value="" id="discount_amount_input"
                       class="discount_amount_input">
        ...
        <tr>
            <td><h4 class="bold"><?= lang('total') ?> :</h4></td>
            <td><h4 class="m0"><span
                        class="total_text"> <?= display_money($c_amount, $currency->symbol) ?></span>
                </h4>
    ...
    <div class="panel panel-custom col-md-12" style="box-shadow: 0 0px 0px 0 rgba(0,0,0,.15);">
        ...
        if ($package_info->allow_2checkout == 'Yes') {
            ...
            <div class="col-md-2 nopad text-center" data-toggle="tooltip" data-placement="top"
                ...
                <label class="image-radio">
                    <img class="thumnail" style="width: 66px"
          ...
          <path class='deco-layer deco-layer--1'
                ...
                fill='#FFFFFF' opacity='0.6'></path>
                    ...
                    <div class='packaging-package'><span
                            class='packaging-currency'> <?= $currency->symbol ?></span><?= ($interval_type == 'monthly' ? $currecy_wise_price->monthly : $currecy_wise_price->yearly) ?>
                ...
                <a data-toggle='modal' data-target='#myModal'
                   href="<?= base_url('admin/global_controller/package_details/' . $package_info->id) ?>"
                   class="text-center mb-lg"><?= lang('see') . ' ' . lang('details') ?></a>
            </div>
        </div>
    </section>
</div>
