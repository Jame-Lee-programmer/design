...
<div class="panel panel-custom">
    ...
    <div class="panel-body form-horizontal">
            ...
            <div class="col-sm-8 ">
                <div class="form-group">
                    <label for="discount_type"
                           class="control-label col-sm-3"><?= lang('select') . ' ' . lang('subscriber') ?><span
                            class="required">*</span></label>
                    <div class="col-sm-9">
                        <select name="subscriptions_id" id="subscriptions_id" class="selectpicker m0" data-width="100%"
            ...
            <div class="form-group">
                <label for="discount_type"
                       class="control-label col-sm-3"><?= lang('select') . ' ' . lang('package') ?><span
                        class="required">*</span></label>
                <div class="col-sm-9">
                    <select name="pricing_id" id="pricing_id" class="selectpicker m0" data-width="100%"
        ...
        <div id="checkout_payment">
            <?php
            $this->load->view('admin/settings/checkout_payment', array('package_info' => $package_info));
            ?>
        </div>
