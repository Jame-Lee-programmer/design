                ...
                <div class="panel panel-custom">
                    ...
                    <div class="panel-body form-horizontal task_details">
                            ...
                            <div class="row">
                                <div class="col-md-3 br">
                                    ...
                                    <form class="form-horizontal p-20">
                                        <?php super_admin_details($task_details->companies_id) ?>
                        ...
                        <?php } else { ?>
                            <div class="form-group">
                                <div class="col-sm-6">
                                    <label class="control-label col-sm-4"><strong><?= lang('task_name') ?>
                                            :</strong></label>
                                    <p class="form-control-static"><?php if (!empty($task_details->task_name)) echo $task_details->task_name; ?></p>
                                </div>
                                <?php super_admin_details_p($task_details->companies_id, 4) ?>
                            </div>
                            <div class="form-group ">
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6">
                                    <label class="control-label col-sm-4"><strong><?= lang('created_by') ?>
                                            :</strong></label>
                                    <div class="col-sm-8 ">
                                        <p class="form-control-static"><?php
                                            if (!empty($task_details->created_by)) {
                            ...
                            <div class="form-group">
                                <div class="col-sm-6">
                                    <label class="control-label col-sm-4"><strong><?= lang('project_hourly_rate') ?>
                                            :</strong></label>
                                    <div class="col-sm-8">
                                        <p class="form-control-static"><?php
                                            if (!empty($task_details->hourly_rate)) {
                                ...
                                <div class="col-sm-6">
                                    <label class="control-label col-sm-4"><strong><?= lang('estimated_hour') ?>
                                            :</strong></label>
                                    <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6">
                                    <label class="control-label col-sm-4"><strong><?= lang('billable') ?>
                                            :</strong></label>
                                    <div class="col-sm-8 ">
                                        <p class="form-control-static">
                                            <?php if (!empty($task_details->billable)) {
                    ...
                    <div class="tab-content bg-white">
                                        ...
                                        foreach ($total_timer as $v_tasks) {
                                            ...
                                            if (!empty($task_info)) {
                                                ...
                                                <tr id="table_tasks_timer-<?= $v_tasks->tasks_timer_id ?>">
                                                    ...
                                                    <td><span
                                                                class="label label-success"><?= display_datetime($v_tasks->start_time, true) ?></span>
                                                    </td>
                                                    <td><span
                                                                class="label label-danger"><?= display_datetime($v_tasks->end_time, true) ?></span>
                                                    </td>
                        ...
                        <div class="tab-pane <?= $time_active == 2 ? 'active' : ''; ?>" id="contact">
                            <form role="form" enctype="multipart/form-data" id="form"
                                ...
                                <?php
                                if (!empty($tasks_timer_info)) {
                                    $start_date = date('Y-m-d H:i', $tasks_timer_info->start_time);
                                    $end_date = date('Y-m-d H:i', $tasks_timer_info->end_time);
                                } else {
