...
<div class="row">
    <div class="col-sm-12">
        <div class="nav-tabs-custom">
                                            ...
                                            <?php if (!empty($edited) || !empty($deleted)) { ?>
                                                <td>
                                                    ...
                                                    if (!empty($can_delete) && !empty($deleted)) {
                                                        ?>
                                                        <?php echo ajax_anchor(base_url("admin/proposals/delete/delete_proposals/" . $v_proposals->proposals_id), "<i class='btn btn-xs btn-danger fa fa-trash-o'></i>", array("class" => "", "title" => lang('delete'), "data-fade-out-on-success" => "#table_proposal_" . $v_proposals->proposals_id)); ?>
                                                    <?php } ?>
                                                    <?php if (!empty($can_edit) && !empty($edited)) { ?>
                                                        <div class="btn-group">
                    ...
                    <?php if (!empty($created) || !empty($edited)) { ?>
                        ...
                        <div class="row">
                            ...
                            <div class="modal-footer">
                                ...
                                <div class="col-sm-2">
                                    <button type="button" id="ProposalReset"
            ...
            <?php include_once 'assets/js/proposal.php'; ?>
