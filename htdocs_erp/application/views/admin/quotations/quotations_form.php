...
<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs">
        <li class="<?= $active == 1 ? 'active' : ''; ?>"><a href="#manage"
                                                            data-toggle="tab"><?= lang('quotations_form') ?></a></li>
        <li class="<?= $active == 2 ? 'active' : ''; ?>"><a href="#new"
                                                            data-toggle="tab"><?= lang('new_quotations_form') ?></a>
        </li>
    </ul>
    <div class="tab-content bg-white">
        ...
        <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="new">
            ...
            <div class="row">
                <div class="col-md-12">
                    <input type="text" required="" style="height: 31px;margin-bottom: 10px;" class="form-control"
                           name="quotationforms_title" autocomplete="off" placeholder="<?= lang('form_title') ?>">
                </div>
            </div>
            <!--WI_QUOTATION_TITLE-->
            <div class="row">
