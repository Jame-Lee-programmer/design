...
if (!empty($quotationforms_info)) {
    $quotationforms_id = $quotationforms_info->quotationforms_id;
    $companies_id = $quotationforms_info->companies_id;
} else {
    $quotationforms_id = null;
    $companies_id = null;
}
echo form_open(base_url('admin/quotations/add_form/' . $quotationforms_id), array('class' => 'form-horizontal', 'id' => 'addQuotationForm', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '', 'role' => 'form')); ?>
<!-- Sidebar ends -->
<!-- Main bar -->
