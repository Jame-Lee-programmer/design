...
if (!empty($created) || !empty($edited)) {
    if (!empty($departments_info)) {
        $departments_id = $departments_info->departments_id;
        $companies_id = $departments_info->companies_id;
    } else {
        $departments_id = null;
        $companies_id = null;
    }
    ?>
    <?php echo form_open(base_url('admin/departments/save_departments/' . $departments_id), array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '', 'role' => 'form')); ?>
    ...
    <div class="panel panel-custom">
        ...
        <div class="col-sm-9">
            <?php super_admin_form($companies_id, 4, 8) ?>
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <select class="form-control select_box" style="width: 100%" name="departments_id"
                        ...
                        <?php $all_department = by_company('tbl_departments', 'departments_id', null, $companies_id);
...
//                        $('select[name="client_id"]').empty();
        ...
        <div class="table-responsive">
            <table class="table table-striped" cellspacing="0" width="100%">
                ...
                $menu_info = get_menu(array('status !=' => 0, 'companies_id' => $companies_id), $companies_id);
                if (!empty($menu_info)) {
