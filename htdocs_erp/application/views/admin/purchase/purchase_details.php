...
<div class="row mb">
            ...
            <ul class="dropdown-menu animated zoomIn">
                <?php if ($this->purchase_model->get_purchase_cost($purchase_info->purchase_id) > 0) { ?>
                    ...
                    <?php if ($purchase_info->status != 'received') { ?>
                        <li>
                            <a href="<?= base_url() ?>admin/purchase/change_status/received/<?= $purchase_info->purchase_id ?>"
                               title="<?= lang('mark_as_received') ?>"><?= lang('mark_as_received') ?></a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>admin/purchase/change_status/pending/<?= $purchase_info->purchase_id ?>"
                               title="<?= lang('mark_as_pending') ?>"><?= lang('mark_as_pending') ?></a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>admin/purchase/change_status/ordered/<?= $purchase_info->purchase_id ?>"
                               title="<?= lang('mark_as_ordered') ?>"><?= lang('mark_as_ordered') ?></a>
                        </li>
                    <?php } ?>
                ...
                if (!empty($can_edit) && !empty($edited)) { ?>
                    <li class="divider"></li>
                    <li>
                        <a href="<?= base_url() ?>admin/purchase/manage_purchase/<?= $purchase_info->purchase_id ?>"><?= lang('edit') . ' ' . lang('purchase') ?></a>
                    </li>
                <?php } ?>
            </ul>
        </div>
    ...
    <div class="col-sm-2 pull-right">
        ...
        <a href="<?= base_url() ?>admin/purchase/manage_purchase/<?= $purchase_info->purchase_id ?>"
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-xs-6 ">
                <div class="pull-right pr-lg">
                    ...
                    <?= super_admin_invoice($purchase_info->companies_id) ?>
                    <?= lang('purchase') . ' ' . lang('date') ?>
                    : <?= display_datetime($purchase_info->purchase_date); ?>
                    <br><?= lang('due_date') ?>
                    : <?= display_datetime($purchase_info->due_date); ?>
                    ...
                    <br><?= lang('status') ?>: <span
                            class="label label-<?= $slabel ?>"><?= lang($purchase_info->status) ?></span>
                </div>
            </div>
