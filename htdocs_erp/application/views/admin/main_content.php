...
$all_report = result_by_company('tbl_dashboard', array('report' => 1), true);
...
$all_order_data = result_by_company('tbl_dashboard', $where, true);
?>
<div class="dashboard">
    <!--        ******** transactions ************** -->
                                                    ...
                                                    <h4 class="mt-sm mb0"><?php
                                                        ...
                                                        if (!empty($all_items)) {
                                                            foreach ($all_items as $in_items) {
                                                                $invoice_date = date('Y-m-d H:i', strtotime($in_items->date_saved));
                                ...
                                <div class="row row-table row-flush">
                                    <div class="col-xs-6 bb br">
                                        <div class="row row-table row-flush">
                                            ...
                                            <div class="col-xs-10">
                                                <div class="text-center">
                                                    <h4 class="mt-sm mb0"><?php
                                                        echo count(result_by_company('tbl_task', array('task_status' => 'in_progress')));
                                                        ?></h4>
                                    ...
                                    <div class="col-xs-6 bb">
                                        <div class="row row-table row-flush">
                                            ...
                                            <div class="col-xs-10">
                                                <div class="text-center">
                                                    <h4 class="mt-sm mb0"> <?= count(result_by_company('tbl_tickets', array('status' => 'open'))); ?></h4>
                                    ...
                                    <div class="col-xs-6 br">
                                        <div class="row row-table row-flush">
                                            ...
                                            <div class="col-xs-10">
                                                <div class="text-center">
                                                    <h4 class="mt-sm mb0"><?php
                                                        echo count(result_by_company('tbl_bug', array('bug_status' => 'in_progress')));
                                                        ?></h4>
                                    ...
                                    <div class="col-xs-6">
                                        <div class="row row-table row-flush">
                                            ...
                                            <div class="col-xs-10">
                                                <div class="text-center">
                                                    <h4 class="mt-sm mb0"><?php
                                                        echo count(result_by_company('tbl_project', array('project_status' => 'in_progress')));
                                                        ?></h4>
                    ...
                    <section class="panel panel-custom menu">
                        ...
                        <?php if ($this->session->userdata('user_type') == '1') { ?>
                            <footer class="panel-footer bg-white no-padder">
                                ...
                                <span
                                        class="h4 font-bold m-t block"><?= count(result_by_company('tbl_project', array('project_status' => 'completed'))) ?>
                                </span>
                                        <small class="text-muted m-b block"><?= lang('complete_projects') ?></small>
                                    </div>
                                    <div class="col-xs-2 b-r b-light">
                                <span
                                        class="h4 font-bold m-t block"><?= count(result_by_company('tbl_task', array('task_status' => 'completed'))) ?>
                                </span>
                                ...
                                <span
                                    ...
                                    <div class="col-xs-2">
                                <span
                                        class="h4 font-bold m-t block"><?= count(result_by_company('tbl_bug', array('bug_status' => 'resolved'))); ?>
                                </span>
                                        <small
                                    ...
                                    <div class="col-xs-2">
                                <span
                                        class="h4 font-bold m-t block"><?= count(result_by_company('tbl_opportunities', array('stages' => 'won'))); ?>
                                </span>
                                        <small
                                    ...
                                    },
                                    {
                                        events: [<?php
                                            ...
                                            if (!empty($searchType) && $searchType == 'holiday' || !empty($searchType) && $searchType == 'all') {
                                                $holiday_info = get_result('tbl_holiday');
                                            }
                                        ...
                                        <tr class="sortable item" data-item-id="<?= $my_todo->todo_id ?>">
                                            ...
                                            <td>
                                                <strong data-toggle="tooltip" data-placement="top"
                                                        title="<?= display_datetime($due_date) ?>"><?= date("l", strtotime($due_date)) ?>
                                    ...
                                    foreach ($my_project as $v_my_project):
                                        if ($v_my_project->project_status != 'completed' AND $v_my_project->progress < 100) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= display_datetime($v_my_project->end_date) ?></td>
            ...
            <?php if ($v_order->name == 'announcements' && $v_order->status == 1) { ?>
                <div class="<?= $v_order->col ?> mt-lg" id="<?= $v_order->id ?>">
                    ...
                    <div class="panel panel-custom menu" style="height: 437px;overflow-y: scroll;">
                        ...
                        <?php
                        $all_announcements = get_result('tbl_announcements');
    ...
    <script type="text/javascript">
        (function (window, document, $, undefined) {
            $(function () {
                ...
                var linectx = document.getElementById("finance_overview");
                if (linectx.getContext) {
                    var lineChart = new Chart(linectx.getContext("2d")).Line(lineData, lineOptions);
                }
                <?php }?>
            });
