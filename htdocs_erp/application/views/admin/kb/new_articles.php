...
if (!empty($created) || !empty($edited)) {
    ...
    <div class="panel panel-custom">
        ...
        <div class="modal-body wrap-modal wrap">
            ...
            echo form_open(base_url('admin/knowledgebase/saved_articles/' . $kb_id), array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '', 'role' => 'form')); ?>
            <?php super_admin_form($companies_id, 2, 9) ?>
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    $('select[name="companies_id"]').on('change', function () {
                        ...
                        if (companies_id) {
                            $.ajax({
                                url: '<?= base_url('admin/global_controller/json_by_company/tbl_kb_category/')?>' + companies_id + '/status/' + true,
                                type: "GET",
                                dataType: "json",
