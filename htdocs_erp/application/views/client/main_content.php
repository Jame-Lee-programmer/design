...
$all_report = get_order_by('tbl_dashboard', array('report' => 2), 'order_no', true);
$all_order_data = get_order_by('tbl_dashboard', array('report' => 3), 'order_no', true);
?>
            ...
            if ($v_order->name == 'announcements' && $v_order->status == 1) {
                ...
                <div class="<?= $v_order->col ?>">
                    <div class="panel panel-custom mb-lg" style="height: 418px;overflow-y: scroll">
                        ...
                        <?php
                        $all_announcements = get_order_by('tbl_announcements', array('all_client' => 1));
