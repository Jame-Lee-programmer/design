<?php
	...
	Patients pa ON ord.PatientID = pa.PatientID AND ProviderID = '$userid' AND ord.clientID = pa.clientID Left JOIN SpecimenType sp ON sp.SpecimenType = ord.SpecimenType Left JOIN OrderTests ot ON ord.OrderID = ot.OrderID Left JOIN Tests t ON t.TestID = ot.TestID WHERE 
	ord.OrderID = '$flag'" ) or die("database error:". sqlsrv_error($conn));
	$result = array();
					...
					<form>
						...
						<div class="row">
							...
							<div class="col-md-10">
								...
								<div class="form-group row">
									<div class="col-md-12">
										<button type="button" class="btn btn-primary" style="width:100%;" id="printRF" onclick="printRF()" <?php if ($row!=null && $row['OrderStatus'] != '10'){ ?>disabled = "false" <?php } ?>><i class="fa fa-print"></i>   PRINT Requisiton Form</button>
									</div>							 
								</div>			
								<div class="form-group row">
									<div class="col-md-12">
...
function printRF(){
	document.getElementById("printRF").disabled = true;
}
function printSL(){
