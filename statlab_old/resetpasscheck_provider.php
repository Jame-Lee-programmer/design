<?php
	...
	if (count($_POST) > 0) {
		$result = sqlsrv_query($conn, "SELECT *from users WHERE ProviderID='$userid'");
        ...
        if(isset($todo) and $todo=="change-password"){
			...
			if (strtoupper($row["password"])==strtoupper($mdpassword)) {
				sqlsrv_query($conn, "UPDATE users set password='" .md5( $_POST["password1"]) . "' WHERE ProviderID='$userid'");
...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<br><br><br><br><br><br>
			<form name="frmChange" id="frmChange" method="post" action="resetpasscheck_provider.php" onSubmit="return validatePassword()">
...
<script type="text/javascript">
	function cancelpass(){
		location.href = "result_provider.php";
	}
</script>
<script type="text/javascript">
