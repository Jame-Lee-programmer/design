...
<div id="Main" class="mainbody">
	<div class="container">
		...
		<div class="row" style="text-align: center;">
			<div class="col-lg-3">	
				<a href="create_orders_provider.php" class="site-btn sb-dart mt-4" style="margin:20px; color:#209948">Create Order</a>
			</div>
			<div class="col-lg-3">   
				<a href="order_status_provider.php?start=1" class="site-btn sb-dark mt-4" style="margin:20px; color:beige;">Order Status</a>
			</div>										
			<div class="col-lg-3">
				<a href="result_provider.php" class="site-btn sb-dark mt-4" style="margin:20px; color:aqua">Result Reports</a>
			</div>
			<div class="col-lg-3">
				<a href="resetpass_provider.php" class="site-btn sb-dark mt-4" style="margin:20px; color:#ff2255" >Reset Password</a>
			</div>
		</div>	
